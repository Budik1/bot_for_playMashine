...
# шаг 31
ttk.Button(text=" на Киевскую ", width=11, command=turist.frunze_kiev).place(x=0, y=246)
ttk.Button(text=" домой ", width=11, command=turist.kiev_frunze).place(x=0, y=277)
ttk.Button(text="кикиморы", width=11, command=turist.za_kikimorami).place(x=0, y=308)
ttk.Label(textvariable=status_kiki, background="#FFCDD2", foreground="#B71C1C", padding=4).place(x=110, y=308)
ttk.Button(text="Паук + Ящер", width=11, command=turist.pauk_yascher).place(x=0, y=339)

ttk.Button(text="most_frunze", width=11, command=turist.most_frunze).place(x=133, y=308)
...
ttk.Button(text="riga_most", width=11, command=turist.riga_most).place(x=242, y=277)
ttk.Button(text="frunze_riga", width=11, command=turist.most_riga).place(x=133, y=339)
ttk.Button(text="riga_frunze", width=11, command=turist.riga_most).place(x=242, y=339)
